    ...
    goalsDetailEl.innerHTML = `
      <div class="memory-detail-shell">
        ...
        <div class="memory-detail-grid">
          ...
          <div class="memory-detail-card"><span class="memory-detail-label">${escapeHtml(t("goals.detailLastRunId", {}, "Last Run ID"))}</span><div class="memory-detail-text">${escapeHtml(lastRunId || "-")}</div></div>
