...
两者互补性很强。P0 三项（自适应检索、硬截断、噪声过滤）和 P1 三项（Task-aware Embedding、长度归一化、内容语义分类）已全部实施完毕（2026-02-25），Belldandy 记忆检索的信噪比和精细度已显著提升。剩余 P2 项（Cross-encoder Rerank、MMR 多样性去重、Scope 隔离）可按需评估实施。
